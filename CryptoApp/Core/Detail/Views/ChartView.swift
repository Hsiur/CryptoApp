...
//  CryptoApp
//
//  Created by Ruslan Ishmukhametov on 29.03.2022.
//
...
extension ChartView {
    ...
    private var chartBackround: some View {
        VStack {
            Divider()
            Spacer()
            Divider()
    ...
    private var chartDateLabel: some View {
        HStack {
            Text(startDate.asShotDateString())
            Spacer()
            Text(endingDate.asShotDateString())
        }
