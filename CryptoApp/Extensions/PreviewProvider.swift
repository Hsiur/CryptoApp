...
class DeveloperPreview {
    ...
    let stat1 = StaticticModel(title: "Рыночная стоимость", value: "$12.56", percentageChange: 45.89)
    let stat2 = StaticticModel(title: "Total Volume", value: "$1.43t")
    let stat3 = StaticticModel(title: "Portfolio Value", value: "$50.32", percentageChange: -17.43)
